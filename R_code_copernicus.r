...
# now let's make a ggplot
ggplot() + geom_raster(NDVI20210110, mapping= aes(x=x, y=y, fill=Normalized.Difference.Vegetation.Index.333M))     # geom_raster is to choose the geometry
                                                                                                                   # fill= name of the file
# N.B. to check how many layers there are inside a "nc" object you can use brick function
